    ...
    >
      <div className="min-h-screen text-[#1A202C]">
        ...
        <header className="flex justify-between items-center px-4 md:px-6 py-3 shadow-md bg-[#FDF6E3] fixed top-0 w-full z-50">
          ...
          <nav className="hidden md:flex">
            <ul className="flex space-x-6 font-medium text-sm md:text-base text-[#1A202C]">
              <li>
                <Link to="/report" className="hover:text-[#68D391]">
                  Report
                </Link>
              </li>
              <li>
                <Link to="/leaderboard" className="hover:text-[#68D391]">
                  Leaderboard
                </Link>
              </li>
              <li>
                <Link to="/alerts" className="hover:text-[#68D391]">
                  Alerts
                </Link>
              </li>
              <li>
        ...
        <section className="text-center py-32 px-4 md:py-40 text-white">
          ...
          <p
            className="max-w-xl md:max-w-2xl mx-auto text-base md:text-lg mb-6"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            You are helping us protect mangroves and empower communities. Keep up the
            great work!
          </p>
          <Link to="/report">
            <button
              className="bg-[#68D391] text-black px-6 py-3 rounded-xl font-semibold shadow-md hover:bg-[#2F855A]"
              data-aos="fade-up"
              data-aos-delay="400"
            >
              Start Reporting
        ...
        <section className="py-12 md:py-20 px-5 md:px-8 w-full mx-auto bg-[#FDF6E3]/90">
          <h3
            className="text-xl md:text-3xl font-bold text-center text-[#2F855A] mb-4 md:mb-8"
            data-aos="fade-up"
          >
            Key Features
          </h3>
          <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-3">
            {/* Report */}
            <div
              className="p-5 bg-[#FDF6E3]/90 rounded-2xl shadow hover:shadow-lg text-[#1A202C]"
              data-aos="fade-up"
            >
              <h4 className="text-base md:text-xl font-semibold text-[#2F855A] mb-2">
                📱 Report Incidents
              </h4>
              <p className="text-sm md:text-base">
                Easily report mangrove incidents directly from your mobile.
              </p>
              <Link to="/report">
                <button className="bg-[#68D391] text-black px-4 py-2 rounded-xl mt-4 hover:bg-[#2F855A]">
                  Report Now
                </button>
              </Link>
            </div>
            ...
            >
              ...
              <p className="text-sm md:text-base">
                See how you rank among the top contributors protecting mangroves.
              </p>
              <Link to="/leaderboard">
                <button className="bg-[#68D391] text-black px-4 py-2 rounded-xl mt-4 hover:bg-[#2F855A]">
                  View Leaderboard
            ...
            >
              ...
              <p className="text-sm md:text-base">
                Get notified about urgent mangrove protection activities.
              </p>
              <Link to="/alerts">
                <button className="bg-[#68D391] text-black px-4 py-2 rounded-xl mt-4 hover:bg-[#2F855A]">
                  Check Alerts
        ...
        <section className="bg-gradient-to-b from-[#039b4f] to-[#4cd8ee] text-white py-16 px-5 md:px-8">
          <div className="max-w-6xl mx-auto text-center" data-aos="fade-up">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              {/* Rank Card */}
              <div
                className="bg-white/10 p-10 rounded-2xl shadow-lg backdrop-blur-md hover:scale-105 transition-transform"
                data-aos="zoom-in"
              >
                <Trophy className="mx-auto text-yellow-300 w-12 h-12 mb-4" />
                <h4 className="text-2xl font-semibold mb-2">Rank</h4>
                <animated.p className="text-5xl font-extrabold">
                  {rankProps.number.to((n) => n.toFixed(0))}
                </animated.p>
              </div>
              {/* Points Card */}
              <div
              ...
              >
                ...
                <animated.p className="text-5xl font-extrabold">
                  {pointsProps.number.to((n) => n.toFixed(0))}
                </animated.p>
              </div>
            </div>
          </div>
